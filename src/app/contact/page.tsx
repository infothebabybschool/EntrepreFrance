...
export const metadata: Metadata = {
  title: "Contact",
  description: "Contactez la rédaction de BEpaper — suggestions, corrections, partenariats.",
};
          ...
          <div className="space-y-6">
            ...
            <div className="bg-navy text-white p-6">
              ...
              <p className="text-sm text-blue-200 leading-relaxed mb-4">
                Restez informé(e) de l&apos;actualité belge. Gratuit, sans publicité.
              </p>
              <a href="/newsletter"
